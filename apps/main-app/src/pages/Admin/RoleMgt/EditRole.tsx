  ...
  return (
    <div>
      ...
      <AdminAlertModal
        ...
        description={<span>Are you sure you want save this changes for role ?  Kindly note that action is irreversible as this new changes would override the existing data.</span>}
        primaryButton={{
